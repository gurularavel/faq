...
export default function Users() {
  ...
  const getData = async (queryParams) => {
    ...
    try {
      const res = await controlPrivateApi.get(`/users/load?${queryParams}`);
          ...
          <Box key={row.id} padding={2} borderBottom={"1px solid #E6E9ED"}>
            ...
            <Box mt={1}>
              <Grid2 container spacing={1}>
                ...
                <Grid2 size={6}>
                  <Typography variant="body">{row.last_login_date}</Typography>
                </Grid2>
                ...
                <Grid2 size={6}>
                  <Typography variant="body">{row.department.title}</Typography>
                </Grid2>
              </Grid2>
            </Box>
            <Box
