...
class QuestionStoreRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'translations.*.title' => [new FirstTranslationRequired('title'), 'max:3000'],
            ...
            'answers.*.translations.*.title' => [new FirstTranslationRequired('title'), 'max:3000'],
        ];
    }
}
