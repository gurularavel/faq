...
/**
 * @OA\Schema(
 *     schema="QuestionGroupStoreRequest",
 *     type="object",
 *     title="Question Group Store Request",
 *     description="Request body for creating a new question group",
 ...
 * )
 */
class QuestionGroupStoreRequest extends FormRequest
{
    /**
